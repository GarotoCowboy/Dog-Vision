...
class DogControllerTest {
    ...
    public void createDogResponse(){
        this.response = new DogResponse("lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT);
    }
    ...
    void listDogsShouldReturn200WithBody() throws Exception {
        DogResponse dog1 = new DogResponse(
                "Pandora", DogRace.BORDER_COLLIER, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT
        );
    ...
    void CreateADogAndReturns200WithABody() throws Exception{
       ...
       CreateDogRequest request = new CreateDogRequest("lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH);
    ...
    void CreateADogWithErrorAndReturns400() throws Exception{
        CreateDogRequest invalidRequest = new CreateDogRequest("lili", null, null, 'F', DATE_OF_BIRTH);
