...
class DogServiceImpTest {
    ...
    void shouldCreateADogWithValidData(){
        ...
        //ARRANGE
        CreateDogRequest dto = new CreateDogRequest("lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH);

        Dog entity = new Dog(UUID.fromString("de13240d-e6b2-4dbf-a2bd-fe58afdd67cb"),
                "lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT);

        DogResponse response = new DogResponse("lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT);
    ...
    void shouldUpdateADogWithValidData(){
        ...
        Dog entity = new Dog(id, "lili", DogRace.LABRADOR, DogStatus.TREINAMENTO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT);

        UpdateDogRequest updateDogRequest = new UpdateDogRequest(id, DogStatus.CEDIDO);
        DogResponse response = new DogResponse("lili", DogRace.LABRADOR, DogStatus.CEDIDO, 'F', DATE_OF_BIRTH, CREATED_AT, UPDATED_AT);
